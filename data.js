...
const testData = [
  ...
  },
  {
    ...
    example: "Ejemplos:\ntirar - arrojar ( I )\nnorte - sur ( O )",
    questions: [
      { id: "S3_Q1", text: "1. salado - dulce", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q2", text: "2. alegrarse - regocijarse", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q3", text: "3. mayor - menor", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q4", text: "4. sentarse - pararse", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q5", text: "5. desperdiciar - aprovechar", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q6", text: "6. conceder - negar", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q7", text: "7. tónico - estimulante", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q8", text: "8. rebajar - denigrar", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q9", text: "9. prohibir - permitir", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q10", text: "10. osado - audaz", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q11", text: "11. arrebatado - prudente", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q12", text: "12. obtuso - agudo", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q13", text: "13. inepto - experto", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q14", text: "14. esquivar - huir", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q15", text: "15. rebelarse - someterse", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q16", text: "16. monotonía - variedad", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q17", text: "17. confrontar - consolar", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q18", text: "18. expeler - retener", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q19", text: "19. dócil - sumiso", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q20", text: "20. transitorio - permanente", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q21", text: "21. seguridad - riesgo", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q22", text: "22. aprobar - objetar", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q23", text: "23. expeler - arrojar", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q24", text: "24. engaño - impostura", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q25", text: "25. mitigar - apaciguar", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q26", text: "26. incitar - aplacar", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q27", text: "27. reverencia - veneración", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q28", text: "28. sobriedad - frugalidad", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q29", text: "29. aumentar - menguar", options: { I: "Igual", O: "Opuesto" } },
      { id: "S3_Q30", text: "30. incitar - instigar", options: { I: "Igual", O: "Opuesto" } }
    ]
  },
  {
    serie: 4,
  ...
  },
  {
    ...
    questions: [
      { id: "S8_Q1", text: "1. con crecen los niños edad la", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q2", text: "2. buena mar beber el para agua de es", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q3", text: "3. lo es paz la guerra opuesto la a", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q4", text: "4. caballos automóvil un que caminan los despacio más", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q5", text: "5. consejo a veces es buen seguir un difícil", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q6", text: "6. cuatrocientas todas páginas contienen libros los", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q7", text: "7. crecen las que fresas el más roble", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q8", text: "8. verdadera comparada no puede amistad ser la", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q9", text: "9. envidia la perjudiciales gula son y la", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q10", text: "10. nunca acciones premiadas las deben buenas ser", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q11", text: "11. exteriores engañan nunca apariencias las nos", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q12", text: "12. nunca es hombres los que acciones demuestran un lo", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q13", text: "13. ciertas siempre muerte de causan clase enfermedades", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q14", text: "14. odio indeseables aversión sentimientos el son y la", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q15", text: "15. frecuentemente por juzgar podemos acciones hombres nosotros sus a los", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q16", text: "16. una son sábana sarampión enfermedades y el", options: { V: "Verdadero", F: "Falso" } },
      { id: "S8_Q17", text: "17. nunca que descuidados los tropiezan son", options: { V: "Verdadero", F: "Falso" } }
    ]
  },
  {
    serie: 9,
